...
function shinyblog_copyright_text($wp_customize) {
  $wp_customize->add_section('nl_copyright_text', array(
    'title' => __('Copyright Information', 'shiny-blog'),
    'description' => __('Add copyright information to the footer section of your website.', 'shiny-blog'),
  ));

  $wp_customize->add_setting("nl_copyright_text", array(
    'sanitize_callback' => 'sanitize_text_field',
    'default' => __('Shiny Blog WordPress Theme | By Janki Moradiya', 'shiny-blog'),
    'transport' => 'refresh',
  ));

  $wp_customize->add_control("nl_copyright_text", array(
    'label' => __('Copyright text', 'shiny-blog'),
    'section' => 'nl_copyright_text',
    'type' => 'textarea',
  ));
}
add_action('customize_register', 'shinyblog_copyright_text');
