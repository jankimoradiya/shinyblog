...
class Shinyblog_Social_Icons_Widget extends WP_Widget {
  ...
  public function form( $instance ) {
    ...
    <p>
      <label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php _e( 'Widget Title', 'shiny-blog' ); ?></label>
...
?>
      ...
      <p>
        <label for="<?php echo esc_attr( $this->get_field_id( 'select_' . $x) ); ?>"><?php _e( '<b>Select Social Icon</b>', 'shiny-blog' ); ?></label>
        <select name="<?php echo esc_attr( $this->get_field_name( 'select_' . $x ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'select_' . $x ) ); ?>" class="widefat">
          <option value="0"><?php _e( '&mdash; Select &mdash;', 'shiny-blog' ); ?></option>
          <?php
